    ...
    if (file) {
      try {
        ...
        const resFile = await axios({
          ...
          data: formData,
          headers: {
            pinata_api_key: `223f15e34a942e8f7b0e`,
            pinata_secret_api_key: `e46a9539e0326cf37566154e4c31e2c35b85a96f0134f8c8123e0b4a23c19bc3`,
        ...
        // Reset file state and file name regardless of success or failure
